...
check_login();
date_default_timezone_set('GMT/London');// change according timezone
...
$_SESSION['msg1']="Password has been Changed Successfully !!";
}
else
{
$_SESSION['msg1']="Old Password not match !!"; //invalid password entry error message
}
}
?>
...
{
alert("Password and Confirm Password Feild do not match  !!");
document.chngpwd.cfpass.focus();
return false;
}
return true;
