...
if($sql)
{
echo "<script>alert('New Doctor info has been added Successfully');</script>";
...
{
alert("Invalid Entry : Password and Confirm Password Field do not match  !!");
...
<script>
	//Check if Email has already been linked to a user profile
...
<div class="form-group">
					...
					<input type="text" name="docfees" class="form-control"  placeholder="Enter Doctor Consultation Fees" required="true">
														</div>
